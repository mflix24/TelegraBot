...
async def welcome(message: types.Message):
    ...
    """
    await message.reply("Hi\nI am a Chat Bot! Created by TeligraBot. How can i assist you?")
...
async def helper(message: types.Message):
    ...
    """
    help_command = """
    Hi There, I'm a bot created by TeligraBot Please follow these commands - 
